...
public class GetInsideMobsForElectricWheel : MonoBehaviour
{
    public GameObject player;
    private CharacterControllerForElectricWheel characterController2D;
    ...
    private void Awake()
    {
        characterController2D = GetComponent<CharacterControllerForElectricWheel>();
